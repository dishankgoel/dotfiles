# Generated by Powerlevel10k configuration wizard on 2021-07-17 at 14:34 IST.
...
# dotted, full frame, dark-ornaments, compact, many icons, concise, transient_prompt,
...
() {
  ...
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='⭐'
    typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=$'%F{#48B9C7}\uf31D'
  ################################[ prompt_char: prompt symbol ]################################
